...
# print() concatenate all strs, displays volume of fuel served to customer

print('To close this window, please type EXIT')

close = input() # Ask user input 'EXIT'

if close == 'EXIT': # if statement terminates program once user input = 'EXIT'
    exit()
